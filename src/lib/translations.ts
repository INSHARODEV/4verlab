    ...
    en: {
        ...
        team: {
            ...
            members: [
                ...
                { name: "Mohammed Fakhrani", role: "Frontend Developer" },
                { name: "Yosef Elwardany", role: "Senior Accountant" },
                { name: "Osama Basha", role: "Core Team" },
                { name: "Afaf Shawwa", role: "Core Team" },
                { name: "Faysal Kurbeh", role: "Core Team" },
                { name: "Mennatullah Assem", role: "Core Team" },
                { name: "Fady Essam", role: "Core Team" },
                { name: "Farida Dahshan", role: "Core Team" },
                { name: "Martina Medhat", role: "Core Team" },
                { name: "Nour Almohamade", role: "Core Team" },
                { name: "Mohammed Abbas", role: "Core Team" },
                { name: "Yasser Basha", role: "Core Team" },
            ]
        },
        map: {
    ...
    ar: {
        ...
        team: {
            ...
            members: [
                ...
                { name: "محمد فخراني", role: "مطور واجهات أمامية" },
                { name: "يوسف الورداني", role: "محاسب أول" },
                { name: "أسامة باشا", role: "الفريق الأساسي" },
                { name: "عفاف شوا", role: "الفريق الأساسي" },
                { name: "فيصل كربه", role: "الفريق الأساسي" },
                { name: "منة الله عاصم", role: "الفريق الأساسي" },
                { name: "فادي عصام", role: "الفريق الأساسي" },
                { name: "فريدة دهشان", role: "الفريق الأساسي" },
                { name: "مارتينا مدحت", role: "الفريق الأساسي" },
                { name: "نور المحمد", role: "الفريق الأساسي" },
                { name: "محمد عباس", role: "الفريق الأساسي" },
                { name: "ياسر باشا", role: "الفريق الأساسي" },
            ]
        },
        map: {
